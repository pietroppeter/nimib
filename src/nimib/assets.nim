...
<head>
  ...
  {{/no_default_style}}
  {{> highlight }}{{^no_default_highlight}}<link rel='stylesheet' href='https://cdn.jsdelivr.net/gh/pietroppeter/nimib/assets/atom-one-light.css'>
  <script src="https://cdn.jsdelivr.net/gh/pietroppeter/nimib/assets/highlight.nim.js"></script>
  <script>hljs.initHighlightingOnLoad();</script>
  {{/no_default_highlight}}
