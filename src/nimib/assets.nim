...
""" # I am not sure how to avoid the </head> tag not to be indented
...
<span id="github">{{#github-remote-url}}<a href="{{github-remote-url}}">{{{github-logo}}}</a>{{/github-remote-url}}</span>
</div>
<style>
div#header-box {
  display: flex;
